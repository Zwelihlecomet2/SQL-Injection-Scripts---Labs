...
def sqli_exploit_find_users_table(url):
...
if __name__ == "__main__":
    ...
    users_table = sqli_exploit_find_users_table(url)
    if users_table:
        ...
        if username_column and password_column:
            ...
            if admin_password:
                ...
                print("[-] Unable to retrieve administrator password.")
        else:
            print("[-] Unable to find username and password columns.")
    else:
